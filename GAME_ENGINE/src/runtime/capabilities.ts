...
export const ENGINE_CAPABILITIES = Object.freeze({
  ...
  physicsMaterials: ['default', 'ice', 'metal', 'rubber', 'wood', 'flesh'],
  movingPlatformModes: ['loop', 'pingpong', 'once'],
  characterControllerPresets: ['platformer2d', 'runner2d', 'simple3d', 'topdown'],
  triggerPhases: ['onEnter', 'onExit', 'onStay'],
