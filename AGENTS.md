# נ® Gaming Vibe Coding - AGENTS.md (CTO Guide)
...
**Core Value Proposition**: Users describe their game idea ג†’ AI asks clarifying questions ג†’ AI generates production-ready 2D/3D games ג†’ Users can iteratively edit and enhance.

---

## נ¯ Key Specifications
...
| **AI Models** | OpenAI GPT-5 (with open-source exploration) |
...
[Chat Interface]
    ג†“
User writes Prompt ג†’ "Build me a fantasy RPG"
    ג†“
[AI Processing Layer]
    ג†“
...
## נ”¨ Template Builder (The Translator)

**Purpose**: Convert JSON ג†’ Playable HTML/JavaScript
...
## נ® Game Generation Workflow (Complete Flow)
...
5. Backend validation loop (same as before)
   ג†“
6. Template Builder converts new JSON ג†’ HTML
   ג†“
...
**Track Everything**:
- ג… All prompts sent
- ג… Generation time (seconds)
- ג… Errors encountered
- ג… User tokens spent
- ג… Games downloaded
- ג… Games edited
- ג… AI model performance
...
## נ€ Development Roadmap (MVP Phase)
...
- [ ] Integration with OpenAI API (or open-source exploration)
- [ ] Validation loop implementation
- [ ] Error handling + retries

### Phase 3: Game Rendering
- [ ] Template Builder implementation
- [ ] JSON ג†’ HTML conversion
...
6. **Test AI integration** (end-to-end: prompt ג†’ MCQs ג†’ JSON ג†’ HTML)
...
## נ“ Resources & References

- **Phaser.js**: https://phaser.io/
- **Three.js**: https://threejs.org/
- **Rapier Physics**: https://www.rapier.rs/
- **Codex API**: https://www.anthropic.com/
